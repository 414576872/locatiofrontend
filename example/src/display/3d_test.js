...
function addFmap() {
  ...
  map = new fengmap.FMMap({
    //渲染dom
    container: document.getElementById('fmap_3d'),
    //地图数据位置
    mapServerURL: './lib/data/' + fmapID,
    //主题数据位置
    mapThemeURL: './lib/data/theme',
    //设置主题
    defaultThemeName: '2001',
    // 默认比例尺级别设置为20级
    defaultMapScaleLevel: 20,
    //开发者申请应用下web服务的key
    key: '1adef9c7b922da6b3dc1c633a8d7da9e',
    //开发者申请应用名称
