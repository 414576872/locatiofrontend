...
(function(factory){
  ...
  Datetimepicker.prototype = {
    ...
    show: function (e) {
      ...
      /**下面几行代码是针对定位项目的特别急救措施，情非得已,因为插件本身绝对定位，脱离文档流的特殊性，针对body来定位置的*/
      $('.chart-container').on('scroll', $.proxy(this.place, this));
      $('.form-body').on('scroll', $.proxy(this.place, this));
      $('.content-area').on('scroll', $.proxy(this.place, this));
      /**急救措施代码到此结束*/
      if (e) {
        e.stopPropagation();
        e.preventDefault();
