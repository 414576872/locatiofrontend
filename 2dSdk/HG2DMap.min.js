...
var HG2DMap={version:"sdk_v0.0.12"};ol.Feature.prototype.getCoordinates=function(){return this.getGeometry().getCoordinates()},ol.Feature.prototype.startFlash=function(e){var t,r;e=e?parseInt(e):300;if(this.getStyle()&&this.getStyle().getImage()){return this.old_images_style=this.getStyle().getImage(),this.images_flash_timer?(console.error("该元素已经在闪烁"),!1):((r=this).images_flash_timer=setInterval(function(){r.getStyle().getImage()?r.getStyle().setImage(null):r.getStyle().setImage(r.old_images_style),r.changed()},e),!0)}if(this.getStyle()&&this.getStyle().getStroke()){return this.old_stroke_color=this.getStyle().getStroke().getColor(),this.stroke_flash_timer?(console.error("该元素已经在闪烁"),!1):((t=this).stroke_flash_timer=setInterval(function(){"rgba(255, 0, 0, 0.5)"==t.getStyle().getStroke().getColor()?(t.getStyle().getStroke().setColor(t.old_stroke_color),t.getStyle().getFill().setColor(t.old_stroke_color)):(t.getStyle().getStroke().setColor("rgba(255, 0, 0, 0.5)"),t.getStyle().getFill().setColor("rgba(255, 0, 0, 0.5)")),t.changed()},e),!0)}return console.error("该元素不能闪烁"),!1},ol.Feature.prototype.stopFlash=function(){return this.images_flash_timer?(clearInterval(this.images_flash_timer),null==this.getStyle().getImage()&&(this.getStyle().setImage(this.old_images_style),this.changed()),!(this.images_flash_timer=void 0)):this.stroke_flash_timer?(clearInterval(this.stroke_flash_timer),"rgba(255, 0, 0, 0.5)"==this.getStyle().getStroke().getColor()&&(this.getStyle().getStroke().setColor(this.old_stroke_color),this.getStyle().getFill().setColor(this.old_stroke_color),this.changed()),!(this.stroke_flash_timer=void 0)):(console.error("该元素并未处于闪烁状态"),!1)},HG2DMap.map=function(o,e,t,r,n,a,l){var s=(l=l||{}).map_text_scale,i=function(e){var t=e.get("name"),r=new ol.style.Style({stroke:new ol.style.Stroke({color:"rgba(52, 0, 0, 0.5)",width:1})});if("Point"==e.getGeometry().getType()){var o=new ol.style.Text({textAlign:"center",textBaseline:"top",font:"14px serif",text:t,scale:s});return r.setText(o),r}return r};if("kml"==n)var c=new ol.layer.Vector({source:new ol.source.Vector({loader:function(){var t=new XMLHttpRequest;t.open("GET",o),t.addEventListener("progress",function(e){if(e.lengthComputable){var t=e.loaded/e.total;b.dispatchEvent({type:"progress",progress:t})}},!1),t.onload=function(){if(200==t.status){var e=c.getSource().getFormat().readFeatures(t.responseText,{featureProjection:b.getView().getProjection()});c.getSource().addFeatures(e)}},t.send()},format:new ol.format.KML({extractStyles:!1}),wrapX:!1}),style:i});else{if("image"!=n)return console.error("错误的type类型"),!1;if("object"!=typeof a||4!=a.length)return console.error("错误的extent值"),!1;c=new ol.layer.Image({source:new ol.source.ImageStatic({url:o,crossOrigin:"",imageExtent:a,imageLoadFunction:function(e){var t=e.getImage(),r=new XMLHttpRequest;r.open("GET",o),r.responseType="blob",r.onprogress=function(e){if(e.lengthComputable){var t=e.loaded/e.total;b.dispatchEvent({type:"progress",progress:t})}},r.onload=function(){if(200==r.status){var e=this.response;t.onload=function(e){window.URL.revokeObjectURL(t.src)},t.src=window.URL.createObjectURL(e)}},r.send()}})})}var _=new ol.source.Vector({features:[],wrapX:!1}),u=[];if(l.cluster_distance&&0<parseInt(l.cluster_distance))(d=new ol.layer.Vector({updateWhileInteracting:!0,source:new ol.source.Cluster({distance:parseInt(l.cluster_distance),source:_,wrapX:!1}),style:function(e){var t=e.get("features"),r=t.length;if(!(1<r)){for(var o in t[0])void 0===e[o]&&(e[o]=t[0][o]);return t[0].getStyle()}var n=u[r];return n||(n=new ol.style.Style({image:new ol.style.Circle({radius:l.radius_function?l.radius_function(e):14+r/2,stroke:new ol.style.Stroke({color:l.cluster_stroke_color?l.cluster_stroke_color:"rgba(255, 153, 0, 0.8)"}),fill:new ol.style.Fill({color:l.cluster_fill_color?l.cluster_fill_color:"rgba(255, 153, 0, 0.8)"})}),text:new ol.style.Text({text:l.cluster_text_function?l.cluster_text_function(e):r.toString(),fill:new ol.style.Fill({color:l.cluster_text_color?l.cluster_text_color:"#fff"})})}),u[r]=n),n}})).cluster=!0;else var d=new ol.layer.Vector({updateWhileInteracting:!0,source:_,wrapX:!1});var g=new ol.source.Vector({features:[],wrapX:!1}),f=new ol.layer.Vector({updateWhileInteracting:!0,source:g}),m=new ol.source.Vector({features:[],wrapX:!1}),p=new ol.layer.Vector({updateWhileInteracting:!0,source:m}),h=new ol.source.Vector({features:[],wrapX:!1}),y=new ol.layer.Vector({updateWhileInteracting:!0,source:h}),v=new ol.source.Vector({features:[],wrapX:!1}),w=new ol.layer.Vector({updateWhileInteracting:!0,source:v}),k=new ol.source.Vector({features:[],wrapX:!1}),x=new ol.layer.Vector({source:k,style:new ol.style.Style({fill:new ol.style.Fill({color:"rgba(255, 255, 255, 0.2)"}),stroke:new ol.style.Stroke({color:"#ffcc33",width:2}),image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"#ffcc33"})})})}),S=new ol.source.Vector({features:[],wrapX:!1}),C=new ol.layer.Heatmap({source:S,blur:7,radius:4}),F=new ol.View({center:t,zoom:r,maxZoom:l.max_zoom,minZoom:l.min_zoom,extent:l.extent,enableRotation:l.enable_rotation,zoomFactor:l.zoom_factor,resolution:l.resolution}),b=new ol.Map({target:document.getElementById(e),view:F,loadTilesWhileInteracting:!0,layers:[c,f,p,y,w,d,x,C]});function T(){for(var e in b.all_person){var t=b.all_person[e];if(t){var r=t.points,o=(new Date).getTime();if(r&&!(r.length<=1)&&(t.animate_start_time||!(r[r.length-1][2]-r[0][2]<=1e3*b.animation_cache_time))){t.animate_start_time||(t.animate_start_time=o);var n=1;4<r.length&&(n=1+r.length/100);var a=(o-t.animate_start_time)/(r[1][2]-r[0][2])*n;if(!isNaN(a)){var l=r[1][3],s=!1;if(1<=a){r.shift(),t.animate_start_time=o;var i=r[0][0],c=r[0][1];s=!0}else if(0==a)i=r[0][0],c=r[0][1];else i=(r[1][0]-r[0][0])*a+r[0][0],c=(r[1][1]-r[0][1])*a+r[0][1];-1!=b.all_track_card.indexOf(parseInt(e))&&b._handleTrackCard(e,i,c,l,s),t.getGeometry().setCoordinates([i,c]),b.dispatchEvent({type:"animate_move",feature:t,coordinates:[i,c]})}}}}}return b.now_zoom=b.getView().getZoom(),l.animation_enable?(d.on("postcompose",T),b.animation_enable=!0,b.animation_cache_time=void 0===l.animation_cache_time?1:parseFloat(l.animation_cache_time),document.addEventListener("visibilitychange",function(){if("hidden"==document.visibilityState)for(var e in b.animation_enable=!1,b.all_person){var t=b.all_person[e];if(t){var r=t.points;if(r){if(2<=r.length){if(-1!=b.all_track_card.indexOf(parseInt(e)))for(var o=1;o<r.length;o++)b._handleTrackCard(e,r[o][0],r[o][1],r[o][3]);t.getGeometry().setCoordinates([r[r.length-1][0],r[r.length-1][1]])}t.points=[],t.animate_start_time=void 0,t.last_map=void 0}}}else b.animation_enable=!0})):b.animation_enable=!1,b.on("moveend",function(e){b.getView().getZoom()!=b.now_zoom&&(b.now_zoom=b.getView().getZoom(),b.getView().dispatchEvent("change:zoom",e))}),"kml"==n?c.getSource().once("change",function(){b.dispatchEvent("loaded")}):"image"==n&&c.getSource().once("imageloadend",function(){b.dispatchEvent("loaded")}),b.all_person=[],b.all_track=[],b.all_track_card=[],b.all_track_max_point_num=[],b.all_track_color=[],b.all_track_point_count=[],b.all_track_dash_distance=[],b.all_station=[],b.all_area=[],b.all_draw_feature=[],b.layer_map=c,b.vector_person_source=_,b.vector_area_source=g,b.vector_track_source=m,b.vector_station_source=h,b.vector_draw_source=v,b.vector_measure_source=k,b.heat_map_source=S,b.vector_person_layer=d,b.vector_area_layer=f,b.vector_track_layer=p,b.vector_station_layer=y,b.vector_draw_layer=w,b.vector_measure_layer=x,b.heat_map_layer=C,b.getClusterFeatures=function(){if(null!=this.vector_person_layer.cluster)return this.vector_person_layer.getSource().getFeatures();console.error("请先开启聚类")},b.setClusterDistance=function(e){if(null!=this.vector_person_layer.cluster)return this.vector_person_layer.getSource().setDistance(e);console.error("请先开启聚类")},b.setMapTextScale=function(e){s=parseFloat(e),this.layer_map.changed()},b.enableCluster=function(e,a){e=e||10,a=a||{};if(null==this.vector_person_layer.cluster){var l=[],t=new ol.layer.Vector({updateWhileInteracting:!0,source:new ol.source.Cluster({distance:parseInt(e),source:this.vector_person_source,wrapX:!1}),style:function(e){var t=e.get("features"),r=t.length;if(!(1<r)){for(var o in t[0])void 0===e[o]&&(e[o]=t[0][o]);return t[0].getStyle()}var n=l[r];return n||(n=new ol.style.Style({image:new ol.style.Circle({radius:a.radius_function?a.radius_function(e):14+r/2,stroke:new ol.style.Stroke({color:a.cluster_stroke_color?a.cluster_stroke_color:"rgba(255, 153, 0, 0.8)"}),fill:new ol.style.Fill({color:a.cluster_fill_color?a.cluster_fill_color:"rgba(255, 153, 0, 0.8)"})}),text:new ol.style.Text({text:a.cluster_text_function?a.cluster_text_function(e):r.toString(),fill:new ol.style.Fill({color:a.cluster_text_color?a.cluster_text_color:"#fff"})})}),l[r]=n),n}});b.getLayers().removeAt(5),b.getLayers().insertAt(5,t),b.animation_enable&&t.on("postcompose",T),this.vector_person_layer=t,this.vector_person_layer.cluster=!0}else console.error("聚类已经开启，请不要重复开启")},b.disableCluster=function(){if(null!=this.vector_person_layer.cluster){var e=new ol.layer.Vector({updateWhileInteracting:!0,source:_,wrapX:!1});b.getLayers().removeAt(5),b.getLayers().insertAt(5,e),b.animation_enable&&e.on("postcompose",T),this.vector_person_layer=e,this.vector_person_layer.cluster=void 0}else console.error("聚类已经关闭，请不要重复关闭")},b.getClusterEnable=function(){return null!=this.vector_person_layer.cluster},b.addCardInfo=function(e,t,r,o,n,a){if(e=parseInt(e),t=t.toString(),r=parseFloat(r),o=parseFloat(o),n=n||e.toString(),a=a||{},b.all_person[e])return this.setCardCoordinate(e,r,o),console.error("该卡已经加入显示，如需更改，请调用相关更新接口"),!1;var l=new ol.style.Style({image:new ol.style.Icon({anchor:[.5,1],src:t,scale:a.icon_scale}),text:new ol.style.Text({textAlign:"center",textBaseline:"top",font:"14px serif",scale:a.text_scale,text:n})}),s=new HG2DMap.feature.point([r,o]);if(s.setStyle(l),b.animation_enable){var i=[[r,o,(new Date).getTime()]];s.points=i}return s.last_point=[r,o],b.all_person[e]=s,b.vector_person_source.addFeature(s),-1!=b.all_track_card.indexOf(e)&&this._handleTrackCard(e,r,o,!1),s},b.setCardIcon=function(e,t,r){if(b.all_person[e]){var o=b.all_person[e].getStyle().getText().getText();r=r||{};var n=new ol.style.Style({image:new ol.style.Icon({anchor:[.5,1],src:t,scale:r.icon_scale}),text:new ol.style.Text({textAlign:"center",textBaseline:"top",font:"14px serif",scale:r.text_scale,text:o})});return b.all_person[e].setStyle(n),b.all_person[e].changed(),b.all_person[e].images_flash_timer&&(b.all_person[e].old_images_style=b.all_person[e].getStyle().getImage()),!0}return console.error("没有该卡的信息，需要先添加定位卡"),!1},b.setCardText=function(e,t){return b.all_person[e]?(b.all_person[e].getStyle().getText().setText(t),b.all_person[e].changed(),!0):(console.error("没有该卡的信息，需要先添加定位卡"),!1)},b.setCardCoordinate=function(e,t,r){e=parseInt(e);var o=[t=parseFloat(t),r=parseFloat(r),(new Date).getTime()];if(-1!=b.all_track_card.indexOf(e)){var n=!1;b.all_track_dash_distance[e]&&b.all_track_dash_distance[e]<this._getTwoPointsDistance(b.all_person[e].last_point,[t,r])&&(n=!0),b.animation_enable?o[3]=n:this._handleTrackCard(e,t,r,n)}if(b.all_person[e]){if(b.animation_enable){if(b.all_person[e].last_point&&b._getTwoPointsDistance(b.all_person[e].last_point,[t,r])<.001)return!b.all_person[e].animate_start_time&&b.all_person[e].points&&1==b.all_person[e].points.length&&(b.all_person[e].points=[o]),!0;b.all_person[e].points?b.all_person[e].points.push(o):b.all_person[e].points=[o],b.vector_person_layer.changed()}else b.all_person[e].getGeometry().setCoordinates([t,r]);return b.all_person[e].last_point=[t,r],!0}return console.error("没有该卡的信息，需要先添加定位卡"),!1},b.removeOneCard=function(e){return e=parseInt(e),b.all_person[e]?(b.vector_person_source.removeFeature(b.all_person[e]),!(b.all_person[e]=void 0)):(console.error("没有该卡的信息，需要先添加定位卡"),!1)},b.removeAllCard=function(){return b.all_person=[],b.vector_person_source.clear(),!0},b.hideAllCard=function(){return b.vector_person_layer.setVisible(!1),!0},b.showAllCard=function(){return b.vector_person_layer.setVisible(!0),!0},b.addBaseStation=function(e,t,r,o,n,a){e=parseInt(e),t=t.toString(),r=parseFloat(r),o=parseFloat(o),n=n||e.toString(),a=a||{};var l=new ol.style.Style({image:new ol.style.Icon({anchor:[.5,1],src:t,scale:a.icon_scale}),text:new ol.style.Text({textAlign:"center",textBaseline:"top",font:"14px serif",scale:a.text_scale,text:n})}),s=[r,o],i=new HG2DMap.feature.point(s);return i.setStyle(l),b.all_station[e]=i,b.vector_station_source.addFeature(i),i},b.removeOneBaseStation=function(e){return e=parseInt(e),b.all_station[e]?(b.vector_station_source.removeFeature(b.all_station[e]),!0):(console.error("没有该基站的信息，需要先添加基站"),!1)},b.removeAllBaseStation=function(){return b.all_station=[],b.vector_station_source.clear(),!0},b.hideAllBaseStation=function(){return b.vector_station_source.clear(),!0},b.showAllBaseStation=function(){for(var e in b.vector_station_source.clear(),b.all_station)b.vector_station_source.addFeature(b.all_station[e]);return!0},b.addZone=function(e,t,r,o){t=parseInt(t),r=r.toString(),o=o||"rgba(52, 64, 255, 0.5)";var n=new ol.style.Style({fill:new ol.style.Fill({color:o}),stroke:new ol.style.Stroke({color:o,width:2}),text:new ol.style.Text({textAlign:"center",font:"14px serif",text:r})}),a=new HG2DMap.feature.polygon(e);return a.setStyle(n),b.all_area[t]=a,b.vector_area_source.addFeature(a),a},b.setZoneColor=function(e,t){return b.all_area[e]?(b.all_area[e].getStyle().getFill().setColor(t),b.all_area[e].getStyle().getStroke().setColor(t),b.all_area[e].changed(),!0):(console.error("没有该区域的信息，需要先添加区域"),!1)},b.setZoneText=function(e,t){return b.all_area[e]?(b.all_area[e].getStyle().getText().setText(t),b.all_area[e].changed(),!0):(console.error("没有该区域的信息，需要先添加区域"),!1)},b.removeOneZone=function(e){return e=parseInt(e),b.all_area[e]?(b.vector_area_source.removeFeature(b.all_area[e]),!0):(console.error("没有该区域的信息，需要先添加区域"),!1)},b.removeAllZone=function(){return b.all_area=[],b.vector_area_source.clear(),!0},b.hideAllZone=function(){return b.vector_area_layer.setVisible(!1),!0},b.showAllZone=function(){return b.vector_area_layer.setVisible(!0),!0},b.addTrack=function(e,t,r,o){return e=parseInt(e),-1==b.all_track_card.indexOf(e)?(t=t||500,b.all_track_dash_distance[e]=o?parseFloat(o):0,b.all_track_color[e]=r||"#"+function(e){return(e+="0123456789abcdef"[Math.floor(16*Math.random())])&&6==e.length?e:arguments.callee(e)}(""),b.all_track_card.push(e),b.all_track_max_point_num[e]=t,!0):(console.error("已经添加了该轨迹，不能重复添加"),!1)},b.removeOneTrack=function(e){if(e=parseInt(e),b.all_track[e]){for(var t in b.all_track[e])b.vector_track_source.removeFeature(b.all_track[e][t]);delete b.all_track[e],delete b.all_track_point_count[e]}return-1==b.all_track_card.indexOf(e)?(console.error("该卡没处于轨迹追踪状态"),!1):(b.all_track_card.splice(b.all_track_card.indexOf(e),1),b.all_track_max_point_num[e]=500,!(b.all_track_color[e]=void 0))},b.removeAllTrack=function(){return b.all_track=[],b.all_track_card=[],b.all_track_max_point_num=[],b.all_track_color=[],b.all_track_point_count=[],b.all_track_dash_distance=[],b.vector_track_source.clear(),!0},b.clearOneTrack=function(e){if(b.all_track[e]){for(var t in b.all_track[e])b.vector_track_source.removeFeature(b.all_track[e][t]);return delete b.all_track[e],delete b.all_track_point_count[e],!0}return console.error("没有该卡的轨迹"),!1},b.clearAllTrack=function(){return b.all_track=[],b.all_track_point_count=[],b.vector_track_source.clear(),!0},b.hideAllTrack=function(){return b.vector_track_layer.setVisible(!1),!0},b.showAllTrack=function(){return b.vector_track_layer.setVisible(!0),!0},b.addPopup=function(e){var t=document.getElementById(e),r=new ol.Overlay({element:t,positioning:"bottom-center",stopEvent:!1,offset:[0,-25]});return b.addOverlay(r),r},b.addInfoBox=function(e){return b.addOverlay(e),!0},b.changeMap=function(o,e,t,r,n,a){if(a=a||{},"kml"==r)var l=new ol.layer.Vector({source:new ol.source.Vector({loader:function(){var t=new XMLHttpRequest;t.open("GET",o),t.addEventListener("progress",function(e){if(e.lengthComputable){var t=e.loaded/e.total;b.dispatchEvent({type:"progress",progress:t})}},!1),t.onload=function(){if(200==t.status){var e=l.getSource().getFormat().readFeatures(t.responseText,{featureProjection:b.getView().getProjection()});l.getSource().addFeatures(e)}},t.send()},format:new ol.format.KML({extractStyles:!1}),wrapX:!1}),style:i});else{if("image"!=r)return console.error("错误的type类型"),!1;if("object"!=typeof n||4!=n.length)return console.error("错误的extent值"),!1;l=new ol.layer.Image({source:new ol.source.ImageStatic({url:o,crossOrigin:"",imageExtent:n,imageLoadFunction:function(e){var t=e.getImage(),r=new XMLHttpRequest;r.open("GET",o),r.responseType="blob",r.onprogress=function(e){if(e.lengthComputable){var t=e.loaded/e.total;b.dispatchEvent({type:"progress",progress:t})}},r.onload=function(){if(200==r.status){var e=this.response;t.onload=function(e){window.URL.revokeObjectURL(t.src)},t.src=window.URL.createObjectURL(e)}},r.send()}})})}return"kml"==r?l.getSource().once("change",function(){b.dispatchEvent("loaded")}):"image"==r&&l.getSource().once("imageloadend",function(){b.dispatchEvent("loaded")}),b.getLayers().removeAt(0),b.getLayers().insertAt(0,l),b.layer_map=l,b.setView(new ol.View({center:e,zoom:t,maxZoom:a.max_zoom,minZoom:a.min_zoom,extent:a.extent,enableRotation:a.enable_rotation,zoomFactor:a.zoom_factor,resolution:a.resolution})),!0},b.reset=function(){return b.all_person=[],b.all_track=[],b.all_track_card=[],b.all_track_max_point_num=[],b.all_track_color=[],b.all_station=[],b.all_area=[],b.all_draw_feature=[],this.removeControlMeasure(),b.vector_person_source.clear(),b.vector_area_source.clear(),b.vector_track_source.clear(),b.vector_station_source.clear(),b.vector_draw_source.clear(),b.vector_measure_source.clear(),b.heat_map_source.clear(),!0},b.addFeature=function(e){return this.vector_draw_source.addFeature(e),!0},b.addFeatures=function(e){return this.vector_draw_source.addFeatures(e),!0},b.removeFeature=function(e){return this.vector_draw_source.removeFeature(e),!0},b.removeAllFeature=function(){return this.vector_draw_source.clear(),!0},b.addHeatMapPoint=function(e,t){var r=new ol.Feature(new ol.geom.Point([e,t]));return r.set("weight",.5),S.addFeature(r),r},b.updateHeatMapPoint=function(e,t,r){e.setGeometry(new ol.geom.Point([t,r]))},b.removeHeatMapPoint=function(e){S.removeFeature(e)},b.clearHeatMap=function(){S.clear()},b.setHeatMapVisible=function(e){this.heat_map_layer.setVisible(e)},b.getZoom=function(){return this.getView().getZoom()},b.setZoom=function(e){return this.getView().setZoom(parseFloat(e))},b.getCenter=function(){return this.getView().getCenter()},b.setCenter=function(e,t){return this.getView().setCenter([parseFloat(e),parseFloat(t)])},b.addControlMeasure=function(e,r){if(this.measure_control)return console.error("已存在测量工具，请先移除已有的测量工具"),!1;var o,i,c,n,_;e="area"==e?"Polygon":"LineString",r=r||{};function u(){i&&i.parentNode.removeChild(i),(i=document.createElement("div")).className="hg_tooltip hg_tooltip_measure",c=new ol.Overlay({element:i,offset:[0,-15],positioning:"bottom-center"}),b.addOverlay(c)}function a(){n&&n.parentNode.removeChild(n),(n=document.createElement("div")).className="hg_tooltip hg_tooltip_measure",_=new ol.Overlay({element:n,offset:[0,-15],positioning:"bottom-center"}),b.addOverlay(_)}var t=new ol.interaction.Draw({source:this.vector_measure_source,type:e,style:new ol.style.Style({fill:new ol.style.Fill({color:"rgba(255, 255, 255, 0.2)"}),stroke:new ol.style.Stroke({color:"rgba(0, 0, 0, 0.5)",lineDash:[10,10],width:2}),image:new ol.style.Circle({radius:5,stroke:new ol.style.Stroke({color:"rgba(0, 0, 0, 0.7)"}),fill:new ol.style.Fill({color:"rgba(255, 255, 255, 0.2)"})})})});this.measure_control=t,this.addInteraction(t),u(),a();var l,d=[];return t.on("drawstart",function(e){o=e.feature;var s=e.coordinate;n.innerHTML="起点",_.setPosition(o.getGeometry().getFirstCoordinate()),l=o.getGeometry().on("change",function(e){var t,r,o,n,a,l=e.target;l instanceof ol.geom.Polygon?(n=l,t=1e4<(a=ol.Sphere.getArea(n))?Math.round(a/1e6*100)/100+" km<sup>2</sup>":Math.round(100*a)/100+" m<sup>2</sup>",s=l.getInteriorPoint().getCoordinates()):l instanceof ol.geom.LineString&&(r=l,t=100<(o=ol.Sphere.getLength(r))?Math.round(o/1e3*100)/100+" km":Math.round(100*o)/100+" m",s=l.getLastCoordinate(),null==l.old_getCoordinates_length&&(l.old_getCoordinates_length=2),l.old_getCoordinates_length<l.getCoordinates().length&&(l.old_getCoordinates_length=l.getCoordinates().length,i.className="hg_tooltip hg_tooltip_static_drawing",c.setOffset([0,-7]),_.setOffset([0,-7]),d.push(i),i=null,u())),i.innerHTML=t,c.setPosition(s)})},this),t.on("drawend",function(e){for(var t in e.feature.getGeometry()instanceof ol.geom.Polygon&&(i.className="hg_tooltip hg_tooltip_static",c.setOffset([0,-7]),_.setOffset([0,-7]),i=null,u()),d)d[t].className="hg_tooltip hg_tooltip_static";n.className="hg_tooltip hg_tooltip_static",n=o=null,a(),ol.Observable.unByKey(l),r.drawend&&r.drawend(e)},this),!0},b.removeControlMeasure=function(){for(var e=document.getElementsByClassName("hg_tooltip_measure");0<e.length;)e[0].parentNode.removeChild(e[0]);for(var t=document.getElementsByClassName("hg_tooltip_static_drawing");0<t.length;)t[0].parentNode.removeChild(t[0]);if(this.measure_control){var r=this;setTimeout(function(){r.removeInteraction(r.measure_control),r.measure_control=void 0},1)}},b.clearMeasureFeature=function(){this.vector_measure_source.clear();for(var e=document.getElementsByClassName("hg_tooltip_static");0<e.length;)e[0].parentNode.removeChild(e[0])},b._handleTrackCard=function(e,t,r,o,n){if(b.all_track[e]&&0<b.all_track[e].length){var a=b.all_track[e].length-1;if(b.all_track[e][a].is_dash==o)b.animation_enable&&n?(this._updateTrackLine(e,t,r),this._addNewTrackLine(e,t,r,o)):this._updateTrackLine(e,t,r);else{var l=b.all_person[e].getGeometry().getCoordinates();this._addNewTrackLine(e,l[0],l[1],o),this._updateTrackLine(e,t,r)}b.animation_enable?n&&b.all_track_point_count[e]++:b.all_track_point_count[e]++}else this._addNewTrackLine(e,t,r,o),b.all_track_point_count[e]=1},b._addNewTrackLine=function(e,t,r,o){var n=void 0;o&&(n=[1,5]);var a=new ol.style.Style({stroke:new ol.style.Stroke({color:b.all_track_color[e],lineDash:n,width:2})}),l=new ol.Feature({geometry:new ol.geom.LineString([[t,r]])});l.setStyle(a),l.is_dash=o,b.vector_track_source.addFeature(l),null==b.all_track[e]?b.all_track[e]=[l]:b.all_track[e].push(l)},b._updateTrackLine=function(e,t,r){var o=b.all_track[e].length-1;if(b.all_track[e][o].getGeometry().appendCoordinate([t,r]),b.all_track_point_count[e]>b.all_track_max_point_num[e]){var n;if(b.animation_enable)b.vector_track_source.removeFeature(b.all_track[e][0]),b.all_track[e].shift();else if(1<(n=b.all_track[e][0].getGeometry().getCoordinates()).length)n.shift(0,1),b.all_track[e][0].getGeometry().setCoordinates(n);else b.vector_track_source.removeFeature(b.all_track[e][0]),b.all_track[e].shift(),(n=b.all_track[e][0].getGeometry().getCoordinates()).shift(0,1),b.all_track[e][0].getGeometry().setCoordinates(n);b.all_track_point_count[e]--}},b._getTwoPointsDistance=function(e,t){return Math.sqrt((e[0]-t[0])*(e[0]-t[0])+(e[1]-t[1])*(e[1]-t[1]))},b},HG2DMap.view=function(e,t,r){return r=r||{},new ol.View({center:e,zoom:t,maxZoom:r.max_zoom,minZoom:r.min_zoom,extent:r.extent,enableRotation:r.enable_rotation,zoomFactor:r.zoom_factor,resolution:r.resolution})},HG2DMap.feature={},HG2DMap.feature.point=function(e,t){var r=new ol.Feature({geometry:new ol.geom.Point(e)});if(r.setCoordinates=function(e){return this.getGeometry().setCoordinates(e),!0},null!=t){var o=void 0,n=void 0;t.icon&&(o=new ol.style.Icon({anchor:[.5,1],src:t.icon,scale:t.icon_scale})),t.text&&(n=new ol.style.Text({textAlign:"center",textBaseline:"top",font:"14px serif",scale:t.text_scale,text:t.text}));var a=new ol.style.Style({image:o,text:n});r.setStyle(a)}return r},HG2DMap.feature.line=function(e){var t=new ol.Feature({geometry:new ol.geom.LineString(e)});return t.setCoordinates=function(e){return this.getGeometry().setCoordinates(e),!0},t},HG2DMap.feature.polygon=function(e){var t=new ol.Feature({geometry:new ol.geom.Polygon([e])});return t.setCoordinates=function(e){return this.getGeometry().setCoordinates([e]),!0},t.updateStyle=function(e,t,r,o){var n=new ol.style.Style({fill:new ol.style.Fill({color:e}),stroke:new ol.style.Stroke({color:t,width:r}),text:new ol.style.Text({textAlign:"center",font:"14px serif",text:o})});this.setStyle(n)},t},HG2DMap.info_box=function(e){var t=document.getElementById(e);return new ol.Overlay({element:t,positioning:"bottom-center",stopEvent:!1,offset:[0,-25]})},HG2DMap.draw={},HG2DMap.draw.line=function(e){return e=e||{},new ol.interaction.Draw({maxPoints:e.max_point,type:"LineString"})},HG2DMap.draw.rectangle=function(){return new ol.interaction.Draw({geometryFunction:new ol.interaction.Draw.createBox,type:"Circle"})},HG2DMap.draw.circle=function(){return new ol.interaction.Draw({type:"Circle"})},HG2DMap.draw.regular_polygon=function(e){return e=e||10,new ol.interaction.Draw({geometryFunction:new ol.interaction.Draw.createRegularPolygon(e),type:"Circle"})},HG2DMap.draw.polygon=function(){return new ol.interaction.Draw({type:"Polygon"})},HG2DMap.draw.select=function(){return new ol.interaction.Select},HG2DMap.draw.modify=function(e){if(null==e)throw"使用HG2DMap.draw.modify必须指定要修改的元素";return new ol.interaction.Modify({features:e})},HG2DMap.draw.translate=function(e){if(null==e)throw"使用HG2DMap.draw.translate必须指定要修改的元素";return new ol.interaction.Translate({features:e})},HG2DMap.draw.drag_rotate=function(){return new ol.interaction.DragRotate({condition:ol.events.condition.altKeyOnly})},HG2DMap.draw.isSelfIntersection=function(e){for(var t=0;t+1<e.length;t++)for(var r=t+2;r<e.length;r++){if(r+1==e.length){if(o(e[t],e[t+1],e[r],e[0]))return!0}else if(o(e[t],e[t+1],e[r],e[r+1]))return!0}return!1;function o(e,t,r,o){return!(0<=((t[0]-e[0])*(o[1]-e[1])-(t[1]-e[1])*(o[0]-e[0]))*((t[0]-e[0])*(r[1]-e[1])-(t[1]-e[1])*(r[0]-e[0])))&&!(0<=((o[0]-r[0])*(t[1]-r[1])-(o[1]-r[1])*(t[0]-r[0]))*((o[0]-r[0])*(e[1]-r[1])-(o[1]-r[1])*(e[0]-r[0])))}},HG2DMap.control={},HG2DMap.control.full_screen=function(e){return e=e||{},new ol.control.FullScreen({className:"hg-full-screen"})},HG2DMap.control.overview_map=function(){return new ol.control.OverviewMap},HG2DMap.control.mouse_position=function(){return new ol.control.MousePosition({className:"hg_mouse_position",coordinateFormat:function(e){return"X："+e[0].toFixed(2)+"，Y："+e[1].toFixed(2)}})},HG2DMap.control.scale_line=function(e,t){return new ol.control.ScaleLine({className:"hg_scale_line",minWidth:e,units:t})},HG2DMap.read={},HG2DMap.read.json=function(e){var t={type:"FeatureCollection",crs:{type:"name",properties:{name:"EPSG:3857"}},features:[{type:"Feature",geometry:{type:"Polygon",coordinates:(e=e||{}).features}}]},r=(new ol.format.GeoJSON).readFeature(t);return r.getCoordinates=function(){return this.getGeometry().getCoordinates()},r.setCoordinates=function(e){return this.getGeometry().setCoordinates(e)},r};